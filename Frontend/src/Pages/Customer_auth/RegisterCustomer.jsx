...
function RegisterCustomer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:3000/bidvault/register_customer", {
        method : "POST",
        headers :{
    ...
    <>
        ...
        <div className="flex h-screen w-screen bg-gray-100">
          ...
          <div className="w-1/2 bg-blue-600 flex items-center justify-center text-white text-4xl font-bold p-10 relative">
            <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('../../public/Images/auction.jpg')" }}></div>
          </div>
          ...
          <div className="w-1/2 flex items-center justify-center p-10 bg-white shadow-lg ">
            <form onSubmit={handleSubmit} className="w-3/4 max-w-md bg-gray-50 p-6 rounded-xl shadow-2xl shadow-black">
              <h2 className="text-2xl font-semibold text-center mb-4">Create Your Account as a <br /> Buyer </h2>
              ...
              <div className="mb-4">
                ...
                <input onChange={(e) => {setContact(e.target.value)}} type="text" name='contact' className="w-full p-2 border border-gray-300 rounded-md" placeholder="Enter contact number" />
              </div>
              ...
              <p align="center">Already Have an account <Link to="/login-customer" className='text-blue-700'>Login here</Link></p>
